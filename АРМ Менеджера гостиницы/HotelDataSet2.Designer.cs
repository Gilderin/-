...
namespace АРМ_Менеджера_гостиницы {
    ...
    public partial class HotelDataSet2 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(int Id, string Name, string SecondName, int ActorId, int Position_Id) {
...
namespace АРМ_Менеджера_гостиницы.HotelDataSet2TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Id], [Name], [SecondName], [ActorId], [Position_I" +
                "d]) VALUES (@Id, @Name, @SecondName, @ActorId, @Position_Id);\r\nSELECT Id, Name, " +
                "SecondName, ActorId, Position_Id FROM Employees WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Id] = @Id, [Name] = @Name, [SecondName] = @SecondName, [ActorId] = @ActorId, [Position_Id] = @Position_Id WHERE (([Id] = @Original_Id) AND ([ActorId] = @Original_ActorId) AND ((@IsNull_Position_Id = 1 AND [Position_Id] IS NULL) OR ([Position_Id] = @Original_Position_Id)));
SELECT Id, Name, SecondName, ActorId, Position_Id FROM Employees WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, SecondName, ActorId, Position_Id FROM dbo.Employees";
        ...
        public virtual int Fill(HotelDataSet2.EmployeesDataTable dataTable) {
        ...
        public virtual HotelDataSet2.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelDataSet2.EmployeesDataTable dataTable = new HotelDataSet2.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelDataSet2.EmployeesDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string Name, string SecondName, int ActorId, global::System.Nullable<int> Position_Id) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(ActorId));
        ...
        public virtual int Update(int Id, string Name, string SecondName, int ActorId, global::System.Nullable<int> Position_Id, int Original_Id, int Original_ActorId, global::System.Nullable<int> Original_Position_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string SecondName, int ActorId, global::System.Nullable<int> Position_Id, int Original_Id, int Original_ActorId, global::System.Nullable<int> Original_Position_Id) {
            return this.Update(Original_Id, Name, SecondName, ActorId, Position_Id, Original_Id, Original_ActorId, Original_Position_Id);
        }
    }
